...
//                       NSLog(@"___:%d",[self hexNumberStringToNumber:[self convertDataToHexStr:characteristics.value]]);
//                       int a = [self hexNumberStringToNumber:[self convertDataToHexStr:characteristics.value]];
//                       NSData *data = [self intToData:a];
